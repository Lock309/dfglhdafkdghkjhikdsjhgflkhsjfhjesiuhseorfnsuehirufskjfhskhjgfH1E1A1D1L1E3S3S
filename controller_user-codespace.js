...
(function () {
                ...
                <div class="control-section">
                    ...
                    <div style="display:flex; flex-direction:column; gap: 12px;">
                        ...
                        <div style="display:flex; gap:12px; align-items:center;">
                            ...
                            <input id="botCount" type="number" value="1" min="1">
                        </div>
    ...
    function createCodespaceEntry(url = "") {
        ...
        entry.innerHTML = `
            ...
            <input type="text" class="cs-url-input" placeholder="ws://localhost:8082" value="${url}">
    ...
    // Legacy connect() wrapper — connects the first codespace or all
    function connect() {
    ...
    // CODESPACE MANAGER — init default entries and wire buttons
    setTimeout(() => {
        DEFAULT_URLS.forEach(url => createCodespaceEntry(url));
        updateHeaderStatus();
